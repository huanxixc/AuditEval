...
if __name__ == '__main__':
    # 设置多个 API 密钥（适用于硅基流动）
    api_keys = [
        "sk-pvztphwzvzgzaubstrpmgqlmjxqhelyuxfmcviitnxwagybv",  # 第一个 API 密钥
        "sk-zgudkxsekrlkaoycnurotkiwyzdwdoqarrvbprawlzzpbzmy",  # 第二个 API 密钥
        "sk-dkijnprxbjxewtvkwdrmjiozmqtuccljuubvcqkmdglbnkwo",  # 第三个 API 密钥
        "sk-hmhavesvbfqshaervyptcikqokphrsaqbhrgwewlcwmjisnr"
    ]

    # 文件路径配置
    # 英译中
    # filename1 = "/root/autodl-tmp/PIXIU/data/文本翻译/英译中/标题翻译/test.json"
    # output_excel_path = "/root/autodl-tmp/ds-r1测评/data/result/excel/文本翻译/英译中/tr_title_en_translation.xlsx"
    # output_json_path = "/root/autodl-tmp/ds-r1测评/data/result/json/文本翻译/英译中/tr_title_en_translation.json" 

    filename1 = "/root/autodl-tmp/PIXIU/data/文本翻译/英译中/法规翻译/test.json"
    output_excel_path = "/root/autodl-tmp/ds-r1测评/data/result/excel/文本翻译/英译中/tr_law_en_translation.xlsx"
    output_json_path = "/root/autodl-tmp/ds-r1测评/data/result/json/文本翻译/英译中/tr_law_en_translation.json" 

    # filename1 = "/root/autodl-tmp/PIXIU/data/文本翻译/英译中/摘要翻译/test.json"
    # output_excel_path = "/root/autodl-tmp/ds-r1测评/data/result/excel/文本翻译/英译中/tr_abstract_en_translation.xlsx"
    # output_json_path = "/root/autodl-tmp/ds-r1测评/data/result/json/文本翻译/英译中/tr_abstract_en_translation.json"  

    # filename1 = "/root/autodl-tmp/PIXIU/data/文本翻译/英译中/关键词翻译/test.json"
    # output_excel_path = "/root/autodl-tmp/ds-r1测评/data/result/excel/文本翻译/英译中/tr_keywords_en_translation.xlsx"
    # output_json_path = "/root/autodl-tmp/ds-r1测评/data/result/json/文本翻译/英译中/tr_keywords_en_translation.json" 
    batch_size = 32

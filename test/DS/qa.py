...
class DSChatLM:
    ...
    def __init__(self, api_keys: List[str], truncate=False, temperature=1.0):
        ...
        self.url = "https://api.siliconflow.cn/v1/chat/completions"  # 修改为硅基流动 API
        self.model = "Pro/deepseek-ai/DeepSeek-R1"  # 硅基流动支持的 DeepSeek-R1 模型
...
def loadData(json_file_path, output_excel_path, output_json_path, batch_size, api_keys):
    try:
        print("Initializing SiliconFlow API client with multiple keys...")
...
if __name__ == '__main__':
    # 设置多个 API 密钥（适用于硅基流动）
    api_keys = [
        "sk-audfqruvmiuktyzcsphsnzmplprwctjzcnouhxgntpjolhbc",
        "sk-ellhmvmokachkzxjhakkixebjjcrvpcgytkmtrphcavtdoxb",
        "sk-xgrherjcgbhbcxlqlgyaspshglwcivociqyhogrjnflkmzwi",
        "sk-unfiswfwhowywsmazxswqmoxvydexupudkqehwaeixqaobhe"
    ]

    # 自动问答
    # filename1 = "/root/autodl-tmp/PIXIU/data/自动问答/审计法规问答/test.json"
    # output_excel_path = "/root/autodl-tmp/ds-r1测评/data/result/excel/自动问答/Audit_law.xlsx"
    # output_json_path = "/root/autodl-tmp/ds-r1测评/data/result/json/自动问答/Audit_law.json"  ok 完
    
    # filename1 = "/root/autodl-tmp/PIXIU/data/自动问答/审计概念问答/test.json"
    # output_excel_path = "/root/autodl-tmp/ds-r1测评/data/result/excel/自动问答/Audit_conception.xlsx"
    # output_json_path = "/root/autodl-tmp/ds-r1测评/data/result/json/自动问答/Audit_conception.json"  ok 完
    
    # filename1 = "/root/autodl-tmp/PIXIU/data/自动问答/审计目标问答/audit_target.json"
    # output_excel_path = "/root/autodl-tmp/ds-r1测评/data/result/excel/自动问答/Audit_Target.xlsx"
    # output_json_path = "/root/autodl-tmp/ds-r1测评/data/result/json/自动问答/Audit_Target.json"  
    
    # filename1 = "/root/autodl-tmp/PIXIU/data/自动问答/审计内容问答/test.json"
    # output_excel_path = "/root/autodl-tmp/ds-r1测评/data/result/excel/自动问答/Audit_content.xlsx"
    # output_json_path = "/root/autodl-tmp/ds-r1测评/data/result/json/自动问答/Audit_content.json"      ok 晚
    
    # filename1 = "/root/autodl-tmp/PIXIU/data/自动问答/审计准则指南/audit_standard1.json"
    # output_excel_path = "/root/autodl-tmp/ds-r1测评/data/result/excel/自动问答/Audit_Standard.xlsx"
    # output_json_path = "/root/autodl-tmp/ds-r1测评/data/result/json/自动问答/Audit_Standard.json"

    ##补充
    # filename1 = "/root/autodl-tmp/ds-r1测评/Audit_Standard/审计准则指南_空白重新测.json"
    # output_excel_path = "/root/autodl-tmp/ds-r1测评/result/excel/自动问答/QA_Standard_buchong.xlsx"
    # output_json_path = "/root/autodl-tmp/ds-r1测评/result/json/自动问答/QA_Standard_buchong.json"

    filename1 = "/root/autodl-tmp/ds-r1测评/Audit_Standard/国家审计准则.json"
    output_excel_path = "/root/autodl-tmp/ds-r1测评/result/excel/自动问答/QA_Standard_guojia.xlsx"
    output_json_path = "/root/autodl-tmp/ds-r1测评/result/json/自动问答/QA_Standard_guojia.json"

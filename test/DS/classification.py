...
if __name__ == '__main__':
    # 设置多个 API 密钥（适用于硅基流动）
    api_keys = [
        "sk-oimleuhhdkaadqgtwoheuyyhazujsoszduuxkpslxkrtcsry",  # 第一个 API 密钥
        "sk-cjefshxbblqyxmmignzccosppfqxwnpbcfylmblcjqrlgyzx",  # 第二个 API 密钥
        "sk-syefxawhemiojsldmbhfbbakhnlhkiczynnpfmmvvnzxzear"   # 第三个 API 密钥
    ]

    # 分类任务
    # test_json_path = "/root/autodl-tmp/PIXIU/data/分类任务/Audit-item entity classification optimization/test.json"
    # out_json_path = "/root/autodl-tmp/ds-r1测评/data/result/json/分类任务/Audit-item entity classification optimization.json"
    # out_excel_path = "/root/autodl-tmp/ds-r1测评/data/result/excel/分类任务/Audit-item entity classification optimization.xlsx" 欧克晚

    # test_json_path = "/root/autodl-tmp/PIXIU/data/分类任务/audit-problem entity classification optimization/test.json"
    # out_json_path = "/root/autodl-tmp/ds-r1测评/data/result/json/分类任务/audit-problem entity classification optimization.json"
    # out_excel_path = "/root/autodl-tmp/ds-r1测评/data/result/excel/分类任务/audit-problem entity classification optimization.xlsx"  ok 晚

    test_json_path = "/root/autodl-tmp/PIXIU/data/分类任务/legal name classification optimization/test.json"
    out_json_path = "/root/autodl-tmp/ds-r1测评/data/result/json/分类任务/legal name classification optimization.json"
    out_excel_path = "/root/autodl-tmp/ds-r1测评/data/result/excel/分类任务/legal name classification optimization.xlsx" ok 晚

    # 设置批次大小
    batch_size = 32

    loadData(test_json_path, out_excel_path, out_json_path, batch_size, api_keys)
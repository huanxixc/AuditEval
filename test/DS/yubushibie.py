...
class DSChatLM:
    ...
    def __init__(self, api_keys: List[str], truncate=False, temperature=1.0):
        ...
        self.model = "Pro/deepseek-ai/DeepSeek-R1"  # 使用硅基流动支持的 DeepSeek-R1 模型
...
if __name__ == '__main__':
    # 设置多个 API 密钥（硅基流动的 API 密钥）
    api_keys = [
        "sk-qkusavkkqbpdtivmyvvqespqjrdkrtomanntpnvrcuoylbnw",  # 第一个 API 密钥
        "sk-lstopvjcxjlfdkywqhpjiohvyjotjtkzjtaitcurnhcxhlxw",  # 第二个 API 密钥
        "sk-hjdbptqgpctljfscfhkqjrmhohjbciajwvtzukgkmmjgeqce",   # 第三个 API 密钥
        "sk-oimleuhhdkaadqgtwoheuyyhazujsoszduuxkpslxkrtcsry",
        "sk-cjefshxbblqyxmmignzccosppfqxwnpbcfylmblcjqrlgyzx",
        "sk-syefxawhemiojsldmbhfbbakhnlhkiczynnpfmmvvnzxzear"
    ]

    # 语步识别任务
    test_json_path = "/root/autodl-tmp/PIXIU/data/语步识别/test.json"
    out_json_path = "/root/autodl-tmp/ds-r1测评/data/result/json/语步识别/speaking_step_cognition.json"
    out_excel_path = "/root/autodl-tmp/ds-r1测评/data/result/excel/语步识别/speaking_step_cognition.xlsx"

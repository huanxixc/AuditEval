...
if __name__ == '__main__':
    ...
    # output_excel_path = "/root/autodl-tmp/ds-r1测评/data/result/excel/自动问答/Audit_problem_summary.xlsx"
    # output_json_path = "/root/autodl-tmp/ds-r1测评/data/result/json/自动问答/Audit_problem_summary.json"   ok
    
    # filename1 = "/root/autodl-tmp/PIXIU/data/文本生成/审计案例撰写/test.json"
    # output_excel_path = "/root/autodl-tmp/ds-r1测评/data/result/excel/文本生成/Audit_case_generation.xlsx"
    # output_json_path = "/root/autodl-tmp/ds-r1测评/data/result/json/文本生成/Audit_case_generation.json"   ok
    
    # filename1 = "/root/autodl-tmp/PIXIU/data/文本生成/审计材料分析/test.json"
    # output_excel_path = "/root/autodl-tmp/ds-r1测评/data/result/excel/文本生成/Audit_material_analyse.xlsx"
    # output_json_path = "/root/autodl-tmp/ds-r1测评/data/result/json/文本生成/Audit_material_analyse.json" ok 晚
